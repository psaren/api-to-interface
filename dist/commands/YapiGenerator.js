            ...
            if (respData && (respData === null || respData === void 0 ? void 0 : respData.res_body_is_json_schema) && (respData === null || respData === void 0 ? void 0 : respData.res_body)) {
                try {
                    ...
                    if (respData.req_body_type === 'json' && respData.req_body_is_json_schema) {
                        ...
                        json_schema_to_typescript_1.compile(reqSchema, interfaceName, atiConfigs.json2TsOptions)
                            .then(ts => {
                    ...
                    if (resSchema) {
                        ...
                        json_schema_to_typescript_1.compile(resSchema, interfaceName, compileOptions)
                            .then(ts => {
                            this.writeInterfaceToFile(utils_1.parseTsCode(ts, utils_1.removeIndexSignatureMiddleWare), name, paths);
                        });
                    }
